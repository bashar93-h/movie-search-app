...
<template>
  <div
    data-cy="movie-card"
    class="bg-secondary-light dark:bg-secondary-dark text-text-light dark:text-text-dark w-64 rounded-xl overflow-hidden transition-colors duration-500 cursor-pointer"
    @click="getToDetails"
    role="button"
    tabindex="0"
  >
